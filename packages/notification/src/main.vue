<template>
  <transition name="el-notification-fade">
    <div
      :class="['el-notification t-notification', customClass, horizontalClass]"
      v-show="visible"
      :style="positionStyle"
    ...
    >
      ...
      <div :class="['t-notification__icon', iconClass]" v-if="type || iconClass">
        <el-icon :tdName="typeClass" :class="type ? 't-is-' + type : ''" />
      </div>
      <div class="t-notification__main">
        <div class="t-notification__title__wrap">
          <span class="t-notification__title">{{ title }}</span>
          <span class="t-message__close"><el-icon tdName="close" v-if="showClose" @click.stop="close" /></span>
        </div>
        <div class="t-notification__content" v-show="message">
          <slot>
