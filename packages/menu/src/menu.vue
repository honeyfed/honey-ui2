  ...
  render(h) {
    const component = (
      <div
        class={[
          't-menu t-menu--light',
          this.mode === 'horizontal' ? 't-head-menu t-head-menu__inner' : 't-default-menu t-default-menu__inner'
        ]}
      >
        <ul
          role="menubar"
    ...
    if (this.collapseTransition) {
      return <el-menu-collapse-transition>{component}</el-menu-collapse-transition>;
    } else {
      return component;
    }
  },
