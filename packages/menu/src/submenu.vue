...
export default {
  ...
  components: { ElCollapseTransition, FakeArrow },
    ...
    const popupMenu = (
      <transition name={menuTransitionName}>
        ...
        >
          <ul
            role="menu"
            class={['el-menu el-menu--popup t-menu__popup-wrapper', `el-menu--popup-${currentPlacement}`]}
      ...
      >
        <div
          class={{
            't-menu__item': true,
            't-is-active': active,
            't-is-active t-is-opened': opened,
        ...
        >
          <span class="t-menu__content">{$slots.title}</span>
          <fake-arrow
            overlayStyle={{ transform: `rotate(${this.isMenuPopup && !this.isFirstLevel ? -90 : 0}deg)` }}
