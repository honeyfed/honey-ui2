  ...
  >
    <div
      ...
      :class="{
        ...
        [`t-slider--with-input`]: showInput,
        [`t-slider--vertical`]: vertical,
        [`t-is-disabled`]: sliderDisabled
      }"
    >
      <div
        class="t-slider__rail"
        :class="{ 'show-input': showInput, disabled: sliderDisabled }"
        :style="runwayStyle"
        @click="onSliderClick"
        ref="slider"
      >
        <div class="t-slider__track" :style="barStyle"></div>
        ...
        <template v-if="showStops">
          <div class="t-slider__stop" v-for="(item, key) in stops" :key="key" :style="getStopStyle(item)"></div>
        </template>
        <template v-if="markList.length > 0">
          <div>
            <div
              ...
              class="t-slider__stop t-slider__marks-stop"
              :key="key"
            ></div>
          </div>
    ...
    <div :class="[`t-slider__input-container`, { 'is-vertical': vertical }]">
      <el-input-number
        v-model="firstValue"
