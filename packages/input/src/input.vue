<template>
  <div
    :class="[
      ...
      type === 'textarea'
        ? {}
        : {
            't-is-disabled': inputDisabled,
            't-is-exceed': inputExceed,
            't-is-focused': focused,
            'el-input-group': $slots.prepend || $slots.append,
            'el-input-group--prepend': $slots.prepend,
            'el-input-group--append': $slots.append,
            't-input--prefix': $slots.prefix || prefixIcon,
            't-input--suffix': $slots.suffix || suffixIcon || clearable || showPassword,
  ...
  >
    <template v-if="type !== 'textarea'">
      <!-- 前置元素 -->
      <div class="t-addon__prepend" v-if="$slots.prepend">
      ...
      <input
        :tabindex="tabindex"
        v-if="type !== 'textarea'"
        :class="innerClass || 't-input__inner'"
        v-bind="$attrs"
      ...
      >
        ...
        <template v-if="!showClear || !showPwdVisible || !isWordLimitVisible">
          ...
          <el-icon :tdName="suffixIcon" />
        </template>
        <el-icon v-if="showClear" tdName="close-circle-filled" @mousedown.prevent @click="clear" />
        <el-icon
          v-if="showPwdVisible"
          :tdName="passwordVisible ? 'browse' : 'browse-off'"
          @click="handlePasswordVisible"
        />
        <!-- <span v-if="isWordLimitVisible" class="t-input__limit">
            <span class="t-textarea__limit"> {{ textLength }}/{{ upperLimit }} </span>
          </span> -->
        <!-- </span> -->
        <i class="el-input__icon" v-if="validateState" :class="['el-input__validateIcon', validateIcon]"> </i>
      </span>
      <!-- 后置元素 -->
      <div class="t-addon__append" v-if="$slots.append">
    ...
    <span v-if="isWordLimitVisible && type === 'textarea'" class="t-textarea__limit">
