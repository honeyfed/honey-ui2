  ...
  <transition name="dialog-fade" @after-enter="afterEnter" @after-leave="afterLeave">
    <div v-show="visible" class="el-dialog__wrapper" @click.self="handleWrapperClick">
      <div
        ...
        :class="[
          't-dialog t-dialog--default t-dialog--top t-dialog__modal-default t-dialog--fixed',
      ...
      >
        ...
        <span class="t-dialog__close" v-if="showClose" @click="handleClose">
          <el-icon tdName="close" />
        </span>
        <div class="t-dialog__body" v-if="rendered"><slot></slot></div>
        <div class="t-dialog__footer" v-if="$slots.footer">
