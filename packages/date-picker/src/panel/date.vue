<template>
  <transition name="el-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
      v-show="visible"
      class="el-picker-panel el-popper"
      :class="[
        {
    ...
    >
      <div class="el-picker-panel__body-wrapper">
        ...
        <div class="el-picker-panel__body t-date-picker__panel">
          ...
          <div
            class="t-date-picker__header"
            :class="{ 'el-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
            v-show="currentView !== 'time'"
          >
            <span class="t-date-picker__header-title">
              <el-button size="medium" class="t-date-picker__header-btn" type="text" @click="showYearPicker">{{
                yearLabel
              }}</el-button>
              <el-button
                size="medium"
                class="t-date-picker__header-btn"
                v-show="currentView === 'date'"
                @click="showMonthPicker"
                type="text"
                >{{ t(`el.datepicker.month${month + 1}`) }}</el-button
              >
            </span>
          ...
          <div :class="`t-date-picker--${currentView}`">
            <date-table
              v-show="currentView === 'date'"
              @pick="handleDatePick"
      ...
      <div class="el-picker-panel__footer" v-show="footerVisible && currentView === 'date'">
        ...
        <el-button plain size="medium" type="primary" class="el-picker-panel__link-btn" @click="confirm">
