<template>
  <transition name="el-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="el-picker-panel el-popper t-popup"
      :class="[
        {
    ...
    >
      <div class="el-picker-panel__body-wrapper">
        ...
        <div class="el-picker-panel__body">
          ...
          <div class="el-date-range-picker__content is-left t-date-picker__panel">
            <div class="t-date-picker__header">
              ...
              <span class="t-date-picker__header-controller">
                <el-button type="text" class="t-date-picker__header-controller__btn" @click="leftPrevMonth">
          ...
          <div class="el-date-range-picker__content is-right t-date-picker__panel">
            <div class="t-date-picker__header">
              <span class="t-date-picker__header-title">
                <span
                  class="t-button t-size-s t-button--variant-text t-button--theme-default t-date-picker__header-btn"
              ...
              <span class="t-date-picker__header-controller">
                ...
                <el-button type="text" class="t-date-picker__header-controller__btn" @click="rightNextMonth">
                  <el-icon tdName="chevron-right" />
                </el-button>
              </span>
              <!-- <button
      ...
      <div class="el-picker-panel__footer" v-if="showTime">
        <el-button size="medium" type="text" class="el-picker-panel__link-btn" @click="handleClear">
