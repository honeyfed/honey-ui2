    ...
    <div v-show="visible" class="t-popup" :class="popperClass">
      <div class="t-popup__content t-time-picker__panel-container">
        <div class="t-time-picker__panel">
          <div class="t-time-picker__panel-section-body" :class="{ 'has-seconds': showSeconds }">
            <time-spinner
              ref="spinner"
              @change="handleChange"
          ...
          <div class="t-time-picker__panel-section-footer">
            <el-button plain size="m" type="primary" class="el-picker-panel__link-btn" @click="handleConfirm()"
              >{{ t('el.datepicker.confirm') }}
            </el-button>
            <el-button plain size="m" type="text" class="el-picker-panel__link-btn" @click="handleCancel"
