<template>
  <transition name="el-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div v-show="visible" class="t-popup" :class="popperClass">
      <div class="t-popup__content t-time-picker__panel-container">
        <div class="t-time-picker__panel">
          <div class="el-time-range-picker__content t-time-picker__panel-section-body">
          ...
          <div class="t-time-picker__panel-section-footer">
            <el-button type="primary" size="m" @click="handleConfirm()">{{ t('el.datepicker.confirm') }}</el-button>
            <el-button type="text" size="m" @click="handleCancel()">{{ t('el.datepicker.cancel') }}</el-button>
          </div>
        </div>
      </div>
    </div>
